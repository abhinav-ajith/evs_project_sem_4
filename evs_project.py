class Info:  # to store details of  a person that impact their carbon footprint
    ...
    def __init__(self):
        ...
        self.food_choice = 0  # types of food you eat (number of types they eat non-veg)
        ...
        self.recycle_elements = 0  # number of types of materials you recycle from the given list
    ...
    def display_info(self):  # to print your details
        ...
        print("Number of times heavy water consuming appliances are used : ", self.water_consumption)
...
def info_input():
    print("Enter the following information , so that we can calculate an approximate impact your household makes in "
          "the environment")
    S = Info()
    ...
    S.food_choice = int(input("Food choice:  \n"
                              ...
                              "choice:"))
    S.water_consumption = int(input("Number of times heavy water consuming appliances are used per week : "))
    S.purchases = int(input("Number of purchases per year at home(electronics,furniture, etc. ): "))
    ...
    S.water_consumption = int(input("Number of recycled material types (this include glass ,plastic,paper , "
                                    "aluminium,steel ,food waste , etc.) : "))
    S.personal_vehicle_distance = int(input("Distance travelled per year in personal vehicle:"))
    S.public_vehicle_distance = int(input("Distance travelled per year in public vehicle:"))
